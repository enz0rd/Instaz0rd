...
export default function Login() {
  return (
    <div className="flex flex-row justify-center items-center h-screen bg-zinc-950 dark:bg-white">
      <div className="flex flex-row items-center justify-center w-1/2 h-full justify-between hidden lg:flex">
        <div className="flex flex-col gap-5 items-center">
            <img src="./src/assets/logo-iz0.png" alt="IZ0 logo" className="w-2/3" />
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col w-[20rem] border-zinc-300 border-2 rounded-xl p-5 text-slate-50">
