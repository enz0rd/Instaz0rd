export default function NotFound() {
    return (
        <div className="bg-gradient-to-br from-zinc-950 via-zinc-850 to-zinc-950 h-screen">
            <div className=" text-slate-50 fixed z-20 h-3/4 w-1/2 m-auto inset-x-0 inset-y-0">
